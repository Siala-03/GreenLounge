export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 inline-flex items-center gap-2 px-4 py-3 bg-[#25D366] text-white rounded-full shadow-lg hover:bg-[#20B958] hover:scale-105 transition-all duration-300 group"
